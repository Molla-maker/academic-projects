...
// MyMFCApp.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMyMFCAppApp

CMyMFCAppApp theApp;


// Инициализация CMyMFCAppApp
...
BOOL CMyMFCAppApp::InitInstance()
{
	...
	SetRegistryKey(_T("MyMFCApplications"));
