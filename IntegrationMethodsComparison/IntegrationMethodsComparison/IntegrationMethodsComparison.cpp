...
// IntegrationMethodsComparison.cpp: определяет поведение классов для приложения.
//
...
// CIntegrationMethodsComparisonApp

BEGIN_MESSAGE_MAP(CIntegrationMethodsComparisonApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CIntegrationMethodsComparisonApp

CIntegrationMethodsComparisonApp::CIntegrationMethodsComparisonApp()
{
...
// Единственный объект CIntegrationMethodsComparisonApp

CIntegrationMethodsComparisonApp theApp;


// Инициализация CIntegrationMethodsComparisonApp

BOOL CIntegrationMethodsComparisonApp::InitInstance()
{
	...
	CIntegrationMethodsComparisonDlg dlg;
	m_pMainWnd = &dlg;
