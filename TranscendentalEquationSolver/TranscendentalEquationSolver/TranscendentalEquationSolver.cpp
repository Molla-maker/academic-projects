...
// TranscendentalEquationSolver.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTranscendentalEquationSolverApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTranscendentalEquationSolverApp

CTranscendentalEquationSolverApp::CTranscendentalEquationSolverApp()
{
...
// Единственный объект CTranscendentalEquationSolverApp

CTranscendentalEquationSolverApp theApp;


// Инициализация CTranscendentalEquationSolverApp

BOOL CTranscendentalEquationSolverApp::InitInstance()
{
	...
	CTranscendentalEquationSolverDlg dlg;
	m_pMainWnd = &dlg;
