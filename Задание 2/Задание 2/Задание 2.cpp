...
// Задание 2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CЗадание2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CЗадание2App

CЗадание2App::CЗадание2App()
{
...
// Единственный объект CЗадание2App

CЗадание2App theApp;


// Инициализация CЗадание2App

BOOL CЗадание2App::InitInstance()
{
